...
class MetrikaRequest extends RequestCore implements ParamRequest
{
    ...
    /**
     * Установка семплирования
     *
     * @param int|string|float $limit
     * @return MetrikaRequest
     */
    public function setAccuracy(int|string|float $accuracy): MetrikaRequest
    {
    ...
    public function setParams(array $params): MetrikaRequest
    {
        ...
        if (!empty($params['accuracy'])) {
            $this->setAccuracy($params['accuracy']);
        }
