...
use App\Services\YandexMetrika\Concerns\DataPreparation;
use App\Services\YandexMetrika\Responses\Concerns\ErrorResponse;
use App\Services\YandexMetrika\Responses\Types\MetrikaRequestData;
use App\Services\YandexMetrika\Responses\Types\MetrikaRequestQuery;
...
class MetrikaResponse
{
     ...
     * 
     * @JMS\Type("App\Services\YandexMetrika\Responses\Types\MetrikaRequestQuery")
     *
     ...
     * Строки ответа
     * 
     * @JMS\Type("array<App\Services\YandexMetrika\Responses\Types\MetrikaRequestData>")
     *
     * @var array
     */
    protected $data;
